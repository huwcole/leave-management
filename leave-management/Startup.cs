...
namespace leave_management
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<ApplicationDbContext>(options => options.UseSqlServer(Configuration["DBConnectionStrings:DefaultConnection"]));

            //add automapper
            services.AddAutoMapper(typeof(Maps));

            //add references to repository and contracts
